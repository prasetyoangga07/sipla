...
<div class="page-title">
        <div class="row">
            ...
            <a href="insert_handphone.php"><button class="btn btn-primary" style="width:150px;">+ Tambah Data</button></a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table" id="table1">
                    ...
                    <?php
        //view join tabel handphone, pengguna, status
        $sql = "SELECT handphone.id_hp AS id, handphone.merek, handphone.tipe, handphone.id_pengguna, pengguna.username AS pemilik, status_perbaikan.status 
                FROM handphone 
