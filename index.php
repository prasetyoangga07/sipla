...
<head>
    ...
    <link rel="shortcut icon" href="assets/assets/images/logo/favicon.svg" type="image/x">
...
<body>
    ...
    <div class="sidebar-header position-relative">
        ...
        <div class="logo">
            ...
            <div>
                <p style="font-size:18px ;">Violet Cell</p>
            </div>
        </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <a href="pelanggan.php"><h6 class="text-muted font-semibold" style="font-size:13px;">Data Pelanggan</h6></a>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                    <div class="stats-icon blue mb-2">
                                        <i class="fa fa-wrench fa-4x py-auto"></i>
                                    </div>
                                </div>
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <a href="sukucadang.php"><h6 class="text-muted font-semibold" style="font-size: 13px;">Suku Cadang</h6></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                    <div class="stats-icon green mb-2">
                                        <i class="fa fa-mobile float-start fa-4x py-auto"></i>
                                    </div>
                                </div>
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <a href="handphone.php"><h6 class="text-muted font-semibold" style="font-size:12.5px ;">Data Handphone</h6></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <a href="transaksi.php"><h6 class="text-muted font-semibold" style="font-size: 13px;">Transaksi</h6></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <a href="perbaikan.php"><h6 class="text-muted font-semibold" style="font-size: 13px;">Rincian perbaikan</h6></a>
                                </div>
                            </div>
                        </div>
                    </div>
