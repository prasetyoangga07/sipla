...
if(isset($_POST['tambah'])){
    ...
    $detail = $_POST['detail_kerusakan'];
    $selected_val = $_POST['status-handphone'];
    $row = mysqli_fetch_array(mysqli_query($conn, "select * from pengguna where email = '$_SESSION[email]' and password = '$_SESSION[password]'"));
    $sql = "insert into handphone(merek, tipe, id_pengguna, detail_kerusakan, id_status) values ('$merek', '$tipe', '$row[id_pengguna]', '$detail', '$selected_val')";
                        ...
                        <div class="card-body">
                            <form class="form" action="" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">Tipe</label>
                                            <input type="text"  class="form-control" placeholder="Masukkan Tipe HP"
                                                name="tipe">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control"
                                                placeholder="Masukan Merek HP" name="merek">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="country-floating">Detail Kerusakan</label>
                                            <textarea rows="" cols="" type="text"  class="form-control"
                                                name="detail_kerusakan" placeholder="Jelaskan Keluhan Handphone"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="handphone.php"><button type="button" class="btn btn-light-secondary me-1 mb-1">Back</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
