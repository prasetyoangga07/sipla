...
if(isset($_POST['tambah'])){
    ...
    $sql = "insert into suku_cadang(nama, harga, stok) values ('$nama', '$harga', '$stok')";
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Masukan data Suku Cadang</h4>
                    </div>
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">ID Suku Cadang</label>
                                            <input type="text"  class="form-control"
                                                placeholder="Masukkan ID Suku Cadang" name="id_sukucadang">
                                        </div>
                                    </div> -->
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">Nama</label>
                                            <input type="text"  class="form-control" placeholder="Masukkan Nama Suku Cadang"
                                                name="nama">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="last-name-column">Stok</label>
                                            <input type="text"  class="form-control"
                                                placeholder="Masukan Stok HP" name="stok">
                                        </div>
                                    </div>
