            ...
            <div id="main">
                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid row">
                        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 gx-2 gy-2 col-6">
                            <div class="col">
                                <div class="callout border-primary rounded-1 shadow ">
                                    <h3><b>Ganti Baterai</b></h3>
                                    <div class="form-group">
                                        <span class="float-right"><i class="fa fa-tags text-muted"></i> Rp.450.000
                                        </span>
                                    </div>
                                    <p class="text-muted"><small>baterai tidak dapat di di cas,stuk baterai, baterai
                                            menggembung,baterai cepat habis dll</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 gx-2 gy-2 col-6">
                            <div class="col">
                                <div class="callout border-primary rounded-0 shadow">
                                    <h3><b>Ganti Casing</b></h3>
                                    <div class="form-group">
                                        <span class="float-right"><i class="fa fa-tags text-muted"></i> Rp.100.000
                                        </span>
                                    </div>
                                    <p class="text-muted"><small>Ganti Casing yang rusak bergaransi 1 tahun</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 gx-2 gy-2 col-6">
                            <div class="col">
                                <div class="callout border-primary rounded-0 shadow">
                                    <h3><b>Ganti Mesin</b></h3>
                                    <div class="form-group">
                                        <span class="float-right"><i class="fa fa-tags text-muted"></i> Rp.1.000.000
                                        </span>
                                    </div>
                                    <p class="text-muted"><small>Ganti Mesin yang rusak bergaransi 1 tahun</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 gx-2 gy-2 col-6">
                            <div class="col">
                                <div class="callout border-primary rounded-0 shadow">
                                    <h3><b>LCD Repair </b></h3>
                                    <div class="form-group">
                                        <span class="float-right"><i class="fa fa-tags text-muted"></i> Rp.900.000
                                        </span>
                                    </div>
                                    <p class="text-muted"><small>Memperbaiki layar LCD yang rusak.</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
