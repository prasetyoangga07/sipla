...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $row = mysqli_fetch_array(mysqli_query($conn, "select * from rincian_perbaikan where id_hp = '$id'"));
    $delete = "DELETE from rincian_perbaikan where id_hp = '$id'";
            ...
            <div class="page-content">
                ...
                <div class="page-title">
                    <div class="row">
                        ...
                        <a href="transaksi.php"><button class="btn btn-primary" style="width:150px;">+ Tambah Data</button></a>
