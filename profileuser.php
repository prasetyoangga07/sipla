...
<div class="page-heading">
    <h3 align="center">Profil Anda</h3>
</div>
<!-- ISI KONTEN -->
        ...
        <div class="col-md-4">
            <div class="card user-card">
                <div class="card-header">
                    <h4 style="color:white ;" align="center">Profile</h4>
                </div>
                <div class="card-block">
                    <div class="user-image">
                        <img src="https://bootdey.com/img/Content/avatar/avatar6.png" class="img-radius" alt="User-Profile-Image">
                    </div>
                    <h6 class="f-w-600 m-t-25 m-b-10"><?php echo $row['username'];?></h6>
                    <p class="text-muted">ID : <?php echo $row['id_pengguna']?></p>
                    <p class="text-muted">email : <?php echo $row['email']?></p>
                    <p class="text-muted">Alamat : <?php echo $row['alamat'];?></p>
                    <p class="text-muted">Nomor Handphone : <?php echo $row['no_hp'];?></p>
