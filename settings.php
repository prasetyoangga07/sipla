...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <!-- LOGO VIOLET -->
        <div class="logo">
                <a href="index.html"><img src="assets/assets/images/logo/v.png" style="width: 60px; height:35px;"height="33px" alt="Logo" srcset="">
...
<div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating"><label class="bmd-label-floating">Masukkan email</label>
                     ...
                     <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" class="form-control" name="pass_lama" id="npwd">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Konfirmasi Passowrd</label>
                          <input type="text" class="form-control" name="konf_pass" >
                        </div>
                      </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted by <span class="text-danger"></span> by <a
