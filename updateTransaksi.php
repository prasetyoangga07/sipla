...
if(isset($_POST['submit'])){
    ...
    $query = mysqli_query($conn, "update transaksi set kode_pembayaran='$kode' where id_transaksi='$id'");
    if ($query){
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Masukan kode pembayaran</h4>
                                </div>
                                            ...
                                            <form class="form" action="" method="post">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="last-name-column">Kode Pembayaran</label>
                                                        <input type="text"  class="form-control" name="kodePembayaran">
                                                    </div>
                                                </div>
                                                <div class="col-12 d-flex">
                                                    <input type="submit" class="btn btn-primary  me-1 mb-1" name="submit" value="Tambah">
                                                    <input type="button" class="btn btn-primary  me-1 mb-1" name="batal" value="Batal" onclick="history.back()">
                                                </div>
                                            </form>
                                    </div>
                                </div>
