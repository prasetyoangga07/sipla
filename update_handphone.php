...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE handphone set merek='$merek', tipe='$tipe', id_pengguna='$id_pengguna', id_status='$selected_val' where id_hp='$id'";
...
<div class="card-body">
    ...
    if(isset($row['id_hp'])){
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                    <label for="last-name-column">Tipe</label>
                    <input type="text"  class="form-control" name="tipe" value="<?php echo $row['tipe'] ?>">
            </div>
        </div>
        <div class="col-md-6 col-12">
            <div class="form-group">
                    <label for="last-name-column">ID Pelanggan</label>
        ...
        <div class="col-md-6 col-12">
            ...
            <div class="col-12 d-flex justify-content-end">
                <input type="submit" class="btn btn-primary  me-1 mb-1" name="edit" value="Edit">
